...
static PyMethodDef __pyx_methods[] = {
  {"alignments_match", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4fnfi_15c_cluster_funcs_1alignments_match, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_c_cluster_funcs(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'c_cluster_funcs' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init fnfi.c_cluster_funcs", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
