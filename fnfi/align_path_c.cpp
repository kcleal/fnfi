...
static PyMethodDef __pyx_mdef_4fnfi_12align_path_c_1optimal_path = {"optimal_path", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4fnfi_12align_path_c_1optimal_path, METH_VARARGS|METH_KEYWORDS, __pyx_doc_4fnfi_12align_path_c_optimal_path};
 ...
 * 
 */
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_pred), __pyx_n_s_fill); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 139, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_3 = NULL;
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_align_path_c(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'align_path_c' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init fnfi.align_path_c", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
